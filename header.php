...
<?php wp_head(); ?> 
  ...
  <body>
      <header class="container-fluid herobg"<?php if ( get_field(' headerbackgroundimage ') ) { echo 'style="background: url(' . get_field(' headerbackgroundimage ') . ')"'; } ?>> <!-- div for the main image that stretches to the edge of the page-->
      <nav class="navbar">
